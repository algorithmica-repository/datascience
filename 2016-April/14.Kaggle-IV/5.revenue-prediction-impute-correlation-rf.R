...
restaurant_train3 = restaurant_train2[,-features_highCorr]
...
model_rf = train(x = restaurant_train4, y = restaurant_train[,"revenue"],
...
restaurant_test3 = restaurant_test2[,-features_highCorr]
...
restaurant_test4$revenue = predict(model_rf,restaurant_test4)
result = data.frame(Id=restaurant_test[,"Id"], revenue=restaurant_test4[,"revenue"])

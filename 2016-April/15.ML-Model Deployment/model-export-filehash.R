...
model_rf = train(x = restaurant_train3[,-features.exclude], y = restaurant_train[,"revenue"],
...
model_knn = train(revenue ~ ., data = restaurant_train3, method = "knn", trControl = tr_ctrl)
model_knn
stopCluster(cl)

##Step5: Export model
file.remove("models.db")
dumpObjects(imputeObj, dbName = "models.db")
dumpObjects(add.features, dbName = "models.db")
dumpObjects(var_obj, dbName = "models.db")
dumpObjects(model_rf, dbName = "models.db")
dumpObjects(model_knn, dbName = "models.db")

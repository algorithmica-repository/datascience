...
lr_grid = {'max_iter':list(range(100,500,100)), 'C':[0.1, 0.2,0.6,0.8,1.0], 'penalty':['l1', 'l2']}
grid_classifier = model_selection.GridSearchCV(classifier, lr_grid, cv=10, refit=True, return_train_score=True)

...
#knn regressor
et_estimator = ensemble.ExtraTreesRegressor(random_state=100)
et_grid = {'n_estimators':list(range(100,1001,100)), 'max_depth':[3,5,9], 'max_features':[4,5,6] }
final_estimator = fit_model_ensemble(et_estimator,et_grid, X_train, y_train)

X_test = house1[house_train.shape[0]:]
X_test = selector.transform(X_test)

house_test['SalePrice'] = final_estimator.predict(X_test)

...
#ml driven feature selection - approach1
fselector1 = feature_selection.SelectFromModel(rf, prefit=True)
X_train1 = fselector1.transform(X_train)

#ml driven feature selection - approach2
fselector2 = feature_selection.RFE(rf, 10)
X_train2 = fselector2.fit_transform(X_train, y_train)

#statistical test driven feature selection 
fselector3 = feature_selection.SelectKBest(feature_selection.chi2, k=10)
X_train3 = fselector3.fit_transform(X_train, y_train)

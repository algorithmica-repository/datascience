...
lr_grid = { 'penalty': ['l1','l2'],  'C':[0.001, 0.01, 1, 10, 100]  }
lr_final_estimator =  cutils.grid_search_best_model(lr_estimator, lr_grid, X_train, y_train)
...
lr_pipeline_estimator = cutils.grid_search_best_model(lr_pipeline, lr_pipeline_grid, X_train, y_train)

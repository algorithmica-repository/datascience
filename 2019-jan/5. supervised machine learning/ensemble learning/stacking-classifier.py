...
st_estimator = classifier.StackingClassifier([dt_estimator,knn_estimator,gnb_estimator,rf_estimator], lr_estimator,store_train_meta_features=True, use_probas=True)

...
linear_grid = {'normalize': [True, False]}
final_estimator = get_model_objective(linear_estimator, linear_grid, X_train, y_train)
plot_model_3d(final_estimator, X_train, y_train)
...
grid_search_two_parameters(rf_estimator, rf_grid, X_train, y_train, scoring = metrics.make_scorer(rmse))
plot_model_2d(final_estimator, X_train, y_train)
...
grid_search_two_parameters(svr_rbf, svr_rbf_grid, X_train, y_train, scoring = metrics.make_scorer(rmse))
plot_model_2d(final_estimator, X_train, y_train)
...
grid_search_two_parameters(svr_poly, svr_poly_grid, X_train, y_train, scoring = metrics.make_scorer(rmse))
plot_model_2d(final_estimator, X_train, y_train)
...
grid_search_one_parameter(knn_estimator, knn_grid, X_train, y_train, scoring = metrics.make_scorer(rmse))
plot_model_2d(final_estimator, X_train, y_train)

...
poly_lr_model,_,_ = get_best_model(poly_lr_estimator, poly_lr_grid, X_train, y_train, scoring = scoring )
plot_model_2d_regression(poly_lr_model, X_train, y_train, title="LinearRegression", color_model='yellow', new_window=True, x_limit=[-4,10], y_limit=[-2,10])

...
grid_search_plot_models_classification(iso_forest_estimator, iso_forest_grid, X, y, xlim=[-7,7], ylim=[-7,7], outlier_estimator=True, levels=[0])

cov_estimator = covariance.EllipticEnvelope()
cov_grid = {'contamination':[0.1, 0.2, 0.25, 0.3]}
grid_search_plot_models_classification(cov_estimator, cov_grid, X, y, xlim=[-7,7], ylim=[-7,7], outlier_estimator=True, levels=[0])
...
grid_search_plot_models_classification(svm_estimator, svm_grid, X, y, xlim=[-7,7], ylim=[-7,7], outlier_estimator=True, levels=[0])
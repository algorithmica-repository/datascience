...
plot_data_2d_outliers(X, y, xlim=[-7,7], ylim=[-7,7])
...
iso_best_model = grid_search_best_model_outliers(iso_forest_estimator, iso_forest_grid, X, y, scoring='f1')
...
grid_search_plot_models_outliers(cov_estimator, cov_grid, X, y, xlim=[-7,7], ylim=[-7,7])
cov_best_model = grid_search_best_model_outliers(cov_estimator, cov_grid, X, y, scoring='f1')
plot_model_2d_outliers(cov_best_model, X, y)
...
grid_search_plot_models_outliers(svm_estimator, svm_grid, X, y, xlim=[-7,7], ylim=[-7,7])
svm_best_model = grid_search_best_model_outliers(svm_estimator, svm_grid, X, y, scoring='f1')
plot_model_2d_outliers(svm_best_model, X, y)
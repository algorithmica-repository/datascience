...
spectral_estimator = cluster.SpectralClustering(affinity='nearest_neighbors', assign_labels='kmeans')
spectral_grid = {'n_clusters':list(range(3,7))}
grid_search_plot_models_2d_clustering(spectral_estimator, spectral_grid, X)
grid_search_plot_one_parameter_curves_clustering(spectral_estimator, spectral_grid, X, scoring = scoring)
spectral_final_model = grid_search_best_model_clustering(spectral_estimator, spectral_grid, X, scoring=scoring)
...
spectral_estimator = cluster.SpectralClustering(affinity='nearest_neighbors', assign_labels='kmeans')
spectral_grid = {'n_clusters':list(range(3,7))}
grid_search_plot_models_3d_clustering(spectral_estimator, spectral_grid, X)
grid_search_plot_one_parameter_curves_clustering(spectral_estimator, spectral_grid, X, scoring = scoring)
spectral_final_model = grid_search_best_model_clustering(spectral_estimator, spectral_grid, X, scoring=scoring)
plot_model_3d_spectral(spectral_final_model, X)
...
spectral_estimator = cluster.SpectralClustering(affinity='nearest_neighbors', assign_labels='kmeans')
spectral_grid = {'n_clusters':list(range(2,6))}
grid_search_plot_models_2d_clustering(spectral_estimator, spectral_grid, X)
grid_search_plot_one_parameter_curves_clustering(spectral_estimator, spectral_grid, X, scoring = scoring)
spectral_final_model = grid_search_best_model_clustering(spectral_estimator, spectral_grid, X, scoring=scoring)
plot_model_2d_clustering(spectral_final_model, X)

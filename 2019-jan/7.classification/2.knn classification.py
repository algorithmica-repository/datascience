...
grid_search_plot_models_classification(knn_estimator, knn_grid, X_train, y_train)
...
plot_model_2d_classification(knn_final_model, X_train, y_train)
performance_metrics_hard_binary_classification(knn_final_model, X_test, y_test)
...
knn_final_model = grid_search_best_model(knn_estimator, knn_grid, X_train, y_train, scoring = scoring )
plot_model_2d_classification(knn_final_model, X_train, y_train)                   
performance_metrics_hard_multiclass_classification(knn_final_model, X_test, y_test)
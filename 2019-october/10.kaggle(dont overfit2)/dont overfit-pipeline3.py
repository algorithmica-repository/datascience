...
pipeline_grid  = {'feature_selector__threshold':['mean', 'median'], 'classifier__C':[0.001, 0.01, 0.1, 0.2, 0.5],'classifier__penalty':['l1', 'l2'], 'classifier__class_weight':['balanced', None]}

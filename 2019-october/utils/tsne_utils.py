...
def plot_tsne_result(X, y, n_components):
    ...
    if X.shape[1] == 3:
        ...
        plot_data_3d_classification(X, y, ax = ax1, title = "Original Data")
    elif X.shape[1] == 2:
        ax1 = fig.add_subplot(3, 4, 1)
        plot_data_2d_classification(X, y, ax = ax1, title = "Original Data")  
    ...
    for i in range(5):
        ...
        if X_iter.shape[1] == 3:
            ...
            plot_data_3d_classification(tmp, y, ax = ax3, title = title)
        elif X_iter.shape[1] == 2:
            ax3 = fig.add_subplot(3, 4, k)
            plot_data_2d_classification(tmp, y, ax = ax3, title = title)  
